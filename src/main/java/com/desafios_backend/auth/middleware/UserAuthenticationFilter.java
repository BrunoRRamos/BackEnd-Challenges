package com.desafios_backend.auth.middleware;
...
import com.desafios_backend.auth.service.JwtTokenService;
...
public class UserAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (checkIfEndpointIsNotPublic(request)) {
            ...
            if (token != null) {
                ...
                throw new RemoteException("Token not found");
            }
        }
    ...
    private boolean checkIfEndpointIsNotPublic(HttpServletRequest request) {
        ...
        return !Arrays
                .asList(SecurityConfiguration.ENDPOINTS_WITH_AUTHENTICATION_NOT_REQUIRED)
                .contains(requestURI);
    }
}
